...
class UsersListSerializer(serializers.ModelSerializer):
    ...
    def get_usersubscriptions(self, obj):
        ...
        if site_visitor.is_anonymous:
            return False
        return Subscriptions.objects.filter(user=site_visitor, author=obj).exists()
...
class RecipeListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Recipe
        fields = ["tags", "author", "products", "name", "image", "text", "cooking_time"]
...
class RecipeDetailsSerializer(serializers.ModelSerializer):
    ...
    products = ProductRecipeSerializer(many=True, read_only=True, source="recipes")
...
class RecipeCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Recipe
        fields = ("name", "image", "text", "products", "tags", "cooking_time", "author")
    ...
    def update(self, data, info):
        ...
        data.cooking_time = info.get("cooking_time", data.cooking_time)
